...
<div class="container">
        ...
        <h3 style="color:rgb(13, 68, 252)"><b>บริการสำหรับนักศึกษา</b></h3>
        <hr>
    </div>
    ...
    <section id="">
      <div class="container">
          <div class="row">
            ...
            <div  class="col-xs-4 col-sm-4 col-md-4 col-lg-4" >
              <p ><a href="http://klogic2.kmutnb.ac.th:8080/kris/index.jsp"><img alt="img" src="{{ asset('img/klogic.jpg') }}" width="100% " height="250px"></a></p>
              <p ><strong><a href="http://klogic2.kmutnb.ac.th:8080/kris/index.jsp" style="color:#4F4F4F;  text-decoration: none ">ระบบสารสนเทศเพื่องานทะเบียนนักศึกษา</a></p></strong>
            </div>
            ...
            <div  class="col-xs-4 col-sm-4 col-md-4 col-lg-4" >
              <p ><a href="http://icit.kmutnb.ac.th/main/rental-laboratory/"><img alt="img" src="{{ asset('img/print.png') }}" width="100% " height="250px"></a></p>
              <p ><strong><a href="http://icit.kmutnb.ac.th/main/rental-laboratory/" style="color:#4F4F4F;  text-decoration: none ">บริการงานพิมพ์</a></p></strong>
            </div>

            <div  class="col-xs-4 col-sm-4 col-md-4 col-lg-4" >
              <p><a href="http://icit.kmutnb.ac.th/main/com-service-room/"><img alt="img" src="{{ asset('img/comRoom.jpg') }}" width="100% " height="250px"></a></p>
              <p><strong><a href="http://icit.kmutnb.ac.th/main/com-service-room/" style="color:#4F4F4F;  text-decoration: none ">ห้องบริการคอมพิวเตอร์และเครือข่ายไร้สาย</a></strong></p>
            </div>
